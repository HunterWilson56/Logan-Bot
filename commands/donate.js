...
module.exports.run = async (client, message, args) => {
    message.channel.send(`Hey there, Do want to donate for \`Logan\`? This is the link https://www.paypal.com/pools/c/826YOnBmFY & https://www.patreon.com/loganbot (if you want to), but, Why would you donate us?\n\
